export function PrivacyPage() {
  return (
    <div style={{ maxWidth: 720, margin: '48px auto', padding: '0 24px', fontFamily: 'sans-serif', lineHeight: 1.7, color: '#111' }}>
      ...
      <p>
        ...
        your <a href="https://myaccount.google.com/permissions" target="_blank" rel="noreferrer">Google Account permissions page</a>.
        To request deletion of your app data, contact <a href="mailto:locol.beef@gmail.com">locol.beef@gmail.com</a>.
      </p>

      <h2>7. Contact</h2>
      <p>
        For any privacy questions, email <a href="mailto:locol.beef@gmail.com">locol.beef@gmail.com</a>.
      </p>
    </div>
  );
}
